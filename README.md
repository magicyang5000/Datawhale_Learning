...
**任务安排**
- Task1：[赛题分析(2天)](./机器学习/数据竞赛(房租预测)/学习任务/Task1.md)
- Task2：[数据清洗(2天)](./机器学习/数据竞赛(房租预测)/学习任务/Task2.md)
- Task3：[特征工程(2天)](./机器学习/数据竞赛(房租预测)/学习任务/Task3.md)
- Task4：[模型选择(2天)](./机器学习/数据竞赛(房租预测)/学习任务/Task4.md)
