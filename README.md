...
**任务安排**
- Task1：[赛题分析(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task1.md)
- Task2：[数据清洗(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task2.md)
- Task3：[特征工程(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task3.md)
- Task4：[模型选择(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task4.md)
- Task5：[模型融合(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task5.md)
- Task6：[比赛整理(2天)](./机器学习/学习任务/数据竞赛(房租预测)/Task6.md)
