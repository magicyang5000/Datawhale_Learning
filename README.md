...
**[课程简介](./理论应用/自然语言处理(基础篇)/README.md)**

**任务安排**
* 预备任务：[tensorflow安装+tensrflow基础+NLP](./理论应用/自然语言处理(基础篇)/学习任务/预备任务.md)
* Task1：[数据集探索（2天）](./理论应用/自然语言处理(基础篇)/学习任务/Task1.md)
* Task2：[特征提取（2天）](./理论应用/自然语言处理(基础篇)/学习任务/Task2.md)
* Task3：[特征选择（2天）](./理论应用/自然语言处理(基础篇)/学习任务/Task3.md)
* Task4：[传统机器学习+讨论（2天）](./理论应用/自然语言处理(基础篇)/学习任务/Task4.md)

### 【自然语言处理(进阶篇)】

**[课程简介](./理论应用/自然语言处理(进阶篇)/README.md)**

**任务安排**
* Task1：[数据集探索（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task1.md)
* Task2：[神经网络基础（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task2.md)
* Task3：[简单神经网络+讨论（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task3.md)
* Task4：[卷积神经网络（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task4.md)
* Task5：[循环神经网络（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task5.md)
* Task6：[Attention原理+讨论（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task6.md)
* Task7：[Bert+讨论（2天）](./理论应用/自然语言处理(进阶篇)/学习任务/Task7.md)
